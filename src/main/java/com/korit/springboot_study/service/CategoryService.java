...
public class CategoryService {
    ...
    public List<Category> getAllCategorys(ReqSearchCategoryDto reqSearchCategoryDto) throws Exception {
        return categoryRepository.findCategoryAll(reqSearchCategoryDto.getKeyword())
